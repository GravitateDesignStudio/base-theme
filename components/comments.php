				...
				if (is_user_logged_in()) {
					...
					<ul id="comment-form-elements" class="comments__form-elements">
						<li>
							...
							<input type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" placeholder="Your Name" tabindex="1" 
																						   <?php
																							if ($req) {
						...
						<li>
							...
							<input type="email" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" placeholder="Your Email" tabindex="2" 
																						  <?php
																							if ($req) {
																								echo 'aria-required="true"';
																							}
