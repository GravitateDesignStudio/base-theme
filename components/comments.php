		...
		if (get_option('comment_registration') && !is_user_logged_in()) {
			...
			<form action="<?php echo esc_url(get_option('siteurl')); ?>/wp-comments-post.php" method="post" id="commentform">
				...
				if (is_user_logged_in()) {
					?>
					<p class="comments-logged-in-as">Logged in as <a href="<?php echo esc_url(get_option('siteurl')); ?>/wp-admin/profile.php"><?php echo esc_html($user_identity); ?></a>. <a href="<?php echo esc_url(wp_logout_url(get_permalink())); ?>" title="Log out of this account">Log out &raquo;</a></p>
					<?php
				} else {
