...
<div class="row style-testing__row wysiwyg">
	...
	<div class="columns small-12 large-6">
		...
		<a href="#" class="button button--slim button--secondary">Button</a>
		<a href="#" class="button button--slim button--secondary active">Button (active)</a>
		<a href="#" class="button button--slim button--secondary disabled" disabled>Button (disabled)</a>
	</div>
</div>
...
<div class="row style-testing__row">
	<div class="columns small-12">
		...
		<div class="gf_browser_gecko gform_wrapper gform_validation_error">
			<form method="post" enctype="multipart/form-data" action="">
				...
				<div class="gform_body">
					<ul class="gform_fields top_label form_sublabel_below description_below">
						<li class="gfield gfield_error gf_left_half gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible">
							<label class="gfield_label" for="input_1_1">Name<span class="gfield_required">*</span></label>
							<div class="ginput_container ginput_container_text">
								<input name="input_1" id="input_1_1" value="" class="large" tabindex="1" placeholder="Name *" aria-required="true" aria-invalid="true" type="text">
							</div>
							<div class="gfield_description validation_message">This field is required.</div>
						</li>
						<li class="gfield gfield_error gf_right_half gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible">
						...
						<li class="gfield gf_left_third field_sublabel_below field_description_below gfield_visibility_visible">
						...
						<li class="gfield gf_middle_third field_sublabel_below field_description_below gfield_visibility_visible">
						...
						<li class="gfield gf_right_third field_sublabel_below field_description_below gfield_visibility_visible">
						...
						<li class="gfield gf_left_half field_sublabel_below field_description_below gfield_visibility_visible">
							...
							<input class="gform_hidden" value="/wp-content/plugins/gravityforms/images/calendar.png" type="hidden">
						</li>
						<li class="gfield gf_right_half field_sublabel_below field_description_below gfield_visibility_visible">
						...
						<li class="gfield gform_validation_container field_sublabel_below field_description_below gfield_visibility_">
							<label class="gfield_label" for="input_1_10">Hidden Validation Field</label>
							<div class="ginput_container">
								<input name="input_10" id="input_1_10" value="" autocomplete="off" type="text">
							</div>
				...
				<div class="gform_footer top_label">
					<input class="gform_button button" value="Submit" tabindex="14" type="submit">
				</div>
			</form>
		</div>
	</div>
