...
class Security {
	public static function disable_dashboard_access_for_roles($roles, $redirect_url = '') {
	...
	public static function set_mimimum_dashboard_access_level($min_level=1, $redirect_url = '') {
		add_action('init', function() use (&$roles, &$redirect_url) {
			if (is_admin() && !defined('DOING_AJAX')) {
