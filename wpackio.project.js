...
module.exports = {
	// Project Identity
	appName: 'baseTheme', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'base-theme', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	...
	watch: './inc|includes|components|grav-blocks/**/*.php',
